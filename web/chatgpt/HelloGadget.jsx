...
const editUiUrl = `${process.env.GADGET_APP_URL}edit/files/web/chatgpt/HelloGadget.jsx`;
const editApiUrl = `${process.env.GADGET_APP_URL}edit/files/api/mcp.js`;
  ...
  return (
    <div>
      <div className="text-center flex flex-col justify-center min-h-[200px]">
        <p className="text-muted-foreground text-sm mb-1 h-4">
