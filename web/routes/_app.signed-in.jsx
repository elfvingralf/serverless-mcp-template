...
export default function () {
  const { gadgetConfig, user } = useOutletContext();
          ...
          <Card className="overflow-hidden">
            <div className="flex items-start justify-between p-6">
              <div className="flex flex-col gap-5">
                ...
                <Button variant="outline" className="w-auto self-start" asChild>
                  <a href="/edit/files/web/routes/_app.signed-in.jsx" target="_blank">
