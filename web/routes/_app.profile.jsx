 ...
 * @returns {React.JSX.Element} A dialog containing a form to edit user's first and last name
 */
 ...
 * @param {boolean} props.open - Controls the visibility of the modal
 * @param {() => void} props.onClose - Callback function to close the modal
 * @returns {React.JSX.Element} A dialog containing a form to change user's password
 */
